...
\begin{rSection}{Highlights of Qualification}
    \scriptsize{
    $\cdot$ Incoming SWE Intern at \textbf{Capital One} (NYC, Summer 2023), Ex-SWE Intern at \textbf{Promise Robotics}, Current 4th Year student at \textbf{UofT}\\
...
\begin{rSubsection}{University of Toronto - \text{Trinity College}}{September 2020 - Present}{Honours Bachelors of Science Candidate- Mathematics (Specialist-with Physics Applications), Physics (Major) Computer Science (Minor), Chemistry (Minor)}{Toronto, ON, Canada}
...
Software Skills & \textbf{Python, Java, MATLAB, Django, Docker, Figma, C, Bash, Open CASCADE, OpenCV, NumPy}\\
